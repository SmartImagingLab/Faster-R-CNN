...
from model.fpn.resnet_IN import Regularization
import matplotlib
matplotlib.use('Agg')
...
def parse_args():
	...
	parser.add_argument('--save_dir', dest='save_dir',
	                    help='directory to save models', default="/home/lab30202/lq/ai_future/low_exporsure_time/low_exporsure_v2/model_save",
...
if __name__ == '__main__':
	...
	if args.dataset == "star_detect":
		args.imdb_name = "traindata600-600"
		args.imdbval_name = "testdata600-600"
	...
	for epoch in range(args.start_epoch, args.max_epochs):
		...
		for i in range(num_images):
			...
			# 遍历除背景外的所有类别，取出每个类别score > thresh( = 0.05)的所有框，NMS(阈值为0 .3)
			for j in range(1, imdb_test.num_classes):
				...
				if inds.numel() > 0:
					...
					keep = nms(cls_dets)  ##　use soft_nms
		...
		if mean_ap >= best_map:
			...
			for key in recs.keys():
				...
				plt.savefig(
					'/home/lab30202/lq/ai_future/low_exporsure_time/low_exporsure_v2/output/visiual_map_loss/session{}_{}_PR.jpg'.format(
						args.session, key))
				plt.close()
		map.append(mean_ap)
	...
	plt.savefig(
		'/home/lab30202/lq/ai_future/low_exporsure_time/low_exporsure_v2/output/visiual_map_loss/session{}test_map.jpg'.format(
			args.session))
	plt.close()
	print("completed!!!")
